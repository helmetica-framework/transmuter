...
func init() {
	assayCmd.Flags().String("path", ".", "path to the reagent chart directory")
	assayCmd.Flags().String("published-url", "", "OCI URL of the published reagent (e.g. oci://ghcr.io/helmetica-framework/myreagent); enables the CRD breakage check")
